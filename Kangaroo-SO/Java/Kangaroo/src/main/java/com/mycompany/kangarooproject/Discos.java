...
public class Discos extends javax.swing.JFrame {
    ...
    public Discos() {
        ...
        // Na linha abaixo existe um macete, a primeira vez que vc for rodar o código
        // por favor, comente a linha, depois da primeira execução,
        // pode descomentar. A primeira vez que for rodar faça isso
        // Se não vai dar bug
        // template.execute("DROP TABLE disco;");
        // Criamos o banco aqui e por quê SÓ FUNCIONA AQUI!
        /* template.execute("CREATE TABLE disco(\n"
                + "     idDisco INT PRIMARY KEY AUTO_INCREMENT,\n"
                + "     total DOUBLE,\n"
                + "     livre DOUBLE,\n"
                + "     usado DOUBLE\n"
                + ");"); */
        // isso aqui eu n sei bem o que é, mas os dados que pegamos ficam aqui dentro
        // essa estrutura que faz os dados mudarem há cada 1 segundo
        timer.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                ...
                for (Disco disco : discos) {
                    ...
                    //BARRA DE PROGRESSO
                    //A barra de progresso só aceita inteiro, por isso convertemos
                ...
                //Falando quais dados vão ser inseridos
                template.update(insert, valorDiscoTotal, valorDiscoLivre);

                //Sout para visualizarmos os dados que estão sendo inseridos
